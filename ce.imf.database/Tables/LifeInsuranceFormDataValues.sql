CREATE TABLE dbo.LifeInsuranceFormDataValues
(
...
GO
CREATE INDEX IX_LifeInsuranceFormDataValues_FormId ON dbo.LifeInsuranceFormDataValues(FormId);
GO
CREATE INDEX IX_LifeInsuranceFormDataValues_SectionId ON dbo.LifeInsuranceFormDataValues(SectionId);
GO
CREATE INDEX IX_LifeInsuranceFormDataValues_FieldId ON dbo.LifeInsuranceFormDataValues(FieldId);
