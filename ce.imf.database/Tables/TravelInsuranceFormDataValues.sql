CREATE TABLE dbo.TravelInsuranceFormDataValues
(
...
GO
CREATE INDEX IX_TravelInsuranceFormDataValues_FormId ON dbo.TravelInsuranceFormDataValues(FormId);
GO
CREATE INDEX IX_TravelInsuranceFormDataValues_SectionId ON dbo.TravelInsuranceFormDataValues(SectionId);
GO
CREATE INDEX IX_TravelInsuranceFormDataValues_FieldId ON dbo.TravelInsuranceFormDataValues(FieldId);
