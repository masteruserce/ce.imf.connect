...
CREATE TABLE dbo.MarineInsuranceFormDataValues
(
...
GO
CREATE INDEX IX_MarineInsuranceFormDataValues_FormId ON dbo.MarineInsuranceFormDataValues(FormId);
GO
CREATE INDEX IX_MarineInsuranceFormDataValues_SectionId ON dbo.MarineInsuranceFormDataValues(SectionId);
GO
CREATE INDEX IX_MarineInsuranceFormDataValues_FieldId ON dbo.MarineInsuranceFormDataValues(FieldId);
